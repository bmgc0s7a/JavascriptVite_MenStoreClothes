...
const sloganContact = function(){
    ...
    divSlogan.classList.add('font-kaushan','bg-slogan', 'md:h-[500px]', 'h-80', 'flex', 'justify-end', 'flex-col', 'items-center', 'p-7');
    const wordSlogan = ['Be Wise', 'Be Patient', 'Be Serene'];
    const h1Slogan = h1(
        'Let Your Essence And Lifestyle OverFlow', ['font-kaushan','text-center', 'text-amber-100', 'uppercase', 'text-2xl']
    );
