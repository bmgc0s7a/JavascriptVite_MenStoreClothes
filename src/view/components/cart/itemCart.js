...
function itemCart() {
    ...
    divActions.append(
        button('less','-',['border-solid', 'border-2', 'border-amber-900','py-1','px-2','rounded-l-md','text-xl']),
        button('quantity','Qtd',['border-solid', 'border-y-2', 'border-amber-900','py-1','px-2','text-xl']),
        button('plus','+',['border-solid', 'border-2', 'border-amber-900','py-1','px-2','rounded-r-md','text-xl']),
        buttonIcon('delete',['fa-solid','fa-trash'],'',['border-solid', 'border-2', 'border-amber-900','py-1','px-2','ml-4','rounded','text-xl']))
    ...
    divItem.classList.add('flex',"bg-white",'flex-col','text-center',"sm:flex-row","sm:justify-between")
